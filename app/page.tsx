...
const text={
  ko: {"eyebrow":"당신에게 드리는 꽃다발","title":"감사합니다.","contributors":"기여자","profile":"프로필 열기"},
en:{eyebrow:'A bouquet for you',title:'Thank you.',contributors:'Contributors',profile:'Open profile'},zh:{eyebrow:'献给你的一束花',title:'谢谢。',contributors:'贡献者',profile:'打开个人主页'},ja:{eyebrow:'あなたへ贈る花束',title:'ありがとう。',contributors:'コントリビューター',profile:'プロフィールを開く'}};
...
export default function HomePage(){
 ...
 useEffect(()=>{const stored=readLanguagePreference();if(stored){const timer=setTimeout(()=>setLanguage(stored),0);return()=>clearTimeout(timer);}},[]);
 ...
 function changeLanguage(next:BrandLocale){
setLanguage(next); persistLanguagePreference(next);
}
